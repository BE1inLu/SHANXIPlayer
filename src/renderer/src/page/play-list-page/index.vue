<template>
    <n-space vertical>
        ...
        <n-tabs class="tab-style" size="medium" type="line" animated placement="left">
            <n-tab-pane v-for=" item of tabList " :key="item.id" :name="item.name" :addable="() => {
                console.log('add');
            }">
...
import { Navigation16Filled, FolderAdd20Filled } from '@vicons/fluent'
